...
const DetailsSerie = ({ handleFavoriClick, favoris }) => {
    const params = useParams();
    const serie = detailsSeries[params.id.toString()]
    return (
        <div className="serie">
            <HeaderSerie titre={serie.title} slogan={serie.tagline} reseau={serie.network} pays={serie.country} status={serie.status} affiche={serie.poster} serie={serie} handleFavoriClick={handleFavoriClick} favoris={favoris} />
